...
import { postsFollowing, postLiked, postUnliked, postComment } from "../store/posts";
...
const FollowingPosts = () => {
  ...
  const posts = useSelector((state) => state.entities.posts.followingPosts);
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(postsFollowing());
  }, [reload]);
